...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: "github", link: "https://github.com/liuxinyudeya" }],
    search: {
      provider: "local",
      options: {
        locales: {
          ...
          items: [
            {
              ...
              items: [
                ...
                { text: "文本与内容", link: "/html/html5/text-content.md" },
                { text: "链接与图像", link: "/html/html5/link-image.md" },
                { text: "基础表格", link: "/html/html5/basic-table.md" },
                { text: "基础表单", link: "/html/html5/basic-form.md" },
                { text: "HTML5 新标签", link: "/html/html5/html5-tags.md" },
                {
                  text: "开发与环境",
                  link: "/html/html5/development-environment.md",
                },
              ],
            },
            {
              ...
              items: [
                {
                  text: "早期 HTML 的局限",
                  link: "/html/related/html-limit.md",
                },
              ],
            },
          ],
          ...
          items: [
            {
              ...
              items: [
                ...
                {
                  text: "视觉格式化模型",
                  link: "/css/css3/visual-formatting-model.md",
                },
                { text: "基本布局", link: "/css/css3/basic-layout.md" },
                { text: "媒体查询", link: "/css/css3/media-query.md" },
                ...
                {
                  text: "工具与环境",
                  link: "/css/css3/development-environment.md",
                },
              ],
            },
            {
              text: "Less",
              collapsed: false,
              items: [{ text: "Less", link: "/css/less/less.md" }],
            },
            {
              text: "Sass",
              collapsed: false,
              items: [{ text: "Sass", link: "/css/sass/sass.md" }],
            },
            {
              text: "TailwindCSS",
              collapsed: false,
              items: [
                {
                  text: "TailwindCSS",
                  link: "/css/tailwindcss/tailwindcss.md",
                },
              ],
            },
            {
              ...
              items: [
                {
                  text: "margin 折叠",
                  link: "/css/related/margin-collapse.md",
                },
                {
                  text: "包含块",
                  link: "/css/related/contain-block.md",
                },
              ],
            },
          ],
          ...
          items: [
            {
              ...
              items: [
                ...
                {
                  text: "内置对象与数据结构",
                  link: "/js/javascript/objects-structures.md",
                },
                {
                  text: "DOM 文档对象模型 ",
                  link: "/js/javascript/basic-dom.md",
                },
                {
                  text: "BOM 浏览器对象模型",
                  link: "/js/javascript/basic-bom.md",
                },
                {
                  text: "基础异步编程",
                  link: "/js/javascript/basic-async.md",
                },
                {
                  text: "错误处理",
                  link: "/js/javascript/error-handling.md",
                },
              ],
            },
          ...
          items: [
            {
              ...
              items: [
                ...
                {
                  text: "模板编译",
                  link: "/vue/vue2/template-compilation.md",
                },
            ...
            },
            {
              text: "Vue3",
              collapsed: false,
              items: [{ text: "VueJs3", link: "/vue/vue3/vue3.md" }],
            },
            {
              text: "vue store",
              collapsed: false,
          ...
          items: [
            {
              text: "webpack",
              collapsed: false,
              items: [{ text: "webpack", link: "/build/webpack/webpack.md" }],
            },
            {
              text: "vue-cli",
              collapsed: false,
              items: [{ text: "vue-cli", link: "/build/vue-cli/vue-cli.md" }],
            },
            {
              text: "vite",
              collapsed: false,
              items: [{ text: "vite", link: "/build/vite/vite.md" }],
            },
          ],
        },
      ],
          ...
          items: [
            {
              text: "Nginx",
              collapsed: false,
              items: [{ text: "Nginx", link: "/others/nginx/nginx.md" }],
            },

            {
              text: "网络与协议",
              collapsed: false,
              items: [{ text: "网络基础", link: "/others/network/network.md" }],
            },
            {
              text: "浏览器",
              collapsed: false,
              items: [
                {
                  text: "浏览器工作原理",
                  link: "/others/browser/browser.md",
                },
              ],
            },

            {
              ...
              items: [
                {
                  text: "What happened",
                  link: "/others/what-happened/what-happened.md",
                },
              ],
            },
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "冒泡排序",
                  link: "/others/algorithm/bubble-sort.md",
                },
